      ...
      <div className="space-y-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-2 text-lg">Manage and monitor your recruitment tasks</p>
          </div>
          <Link href="/generate">
            <Button className="btn-hover">
              <Plus className="mr-2 h-4 w-4" />Generate New Task
            </Button>
          </Link>
        </div>
          ...
          <Card className="glass-card">
            <CardContent className="text-center p-16 space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-base">Get started by generating your first AI-powered recruitment task</p>
              </div>
              <Link href="/generate">
                <Button size="lg" className="btn-hover">
                  <Plus className="mr-2 h-4 w-4" />Generate Your First Task
                </Button>
              </Link>
            </CardContent>
          </Card>
              ...
              <Card key={task.id} className="glass-card project-card-hover">
                ...
                <CardContent className="p-6 pt-4">
                  <div className="space-y-4">
                    ...
                    <div className="pt-2">
                      <Link href={`/projects/${task.id}`} className="w-full block">
                        <Button variant="default" className="w-full btn-project-hover">View Details</Button>
                      </Link>
                    </div>
                  </div>
                </CardContent>
